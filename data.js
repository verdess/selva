...
window.SELVA_DATA = (function(){
  ...
  const projects = [
    ...
    },
    {
      ...
      paragraphs: {
        es: [
          "Una campaña de salud que no parece una campaña de salud. Selva construyó una serie de cuadros familiares, una abuela, un corredor matutino, una niña aprendiendo a nadar, con una paleta cálida de ventana y lámpara. La farmacéutica se presenta sin decir su nombre hasta el último cuadro.",
          "Rodaje de cuatro días en locación real, sin extras, sin utilería. Solo gente viviendo su día."
        ],
        en: [
          "A health campaign that doesn't look like a health campaign. Selva built a series of family vignettes, a grandmother, a morning runner, a girl learning to swim, in a warm window-and-lamp palette. The brand doesn't name itself until the final frame.",
    ...
    },
    {
      ...
      paragraphs: {
        es: [
          "El brief era complicado: una serie adolescente con tono sombrío y título depresivo. Selva lo tomó como desafío de dirección de arte. Paleta azul deslavado, cuadros sobrios, talento con la actitud justa de quien ya no cree en nada pero sigue yendo a la escuela.",
          "Tres días de rodaje, equipo reducido. Menos producción, más presencia. La pieza vive de silencios más que de frases."
        ],
        en: [
          "A tricky brief: a teen series with a somber tone and a depressive title. Selva took it as an art direction challenge. Washed-out blue palette, sober frames, talent carrying the precise attitude of people who believe in nothing but still show up to school.",
    ...
    {
      id: "senorita-89",
      client: "Lionsgate · Pantaya",
      title: { es: "Señorita 89, Temporada 1", en: "Señorita 89, Season 1" },
      kicker: { es: "Pieza de lanzamiento para la temporada uno.", en: "Launch piece for season one." },
      category: "Streaming Original",
      director: "SELVA",
      year: 2024,
      vimeo: {"id":"1046912567"},
      agency: "Pantaya · Lionsgate",
      frame: { bg: "var(--vino)", fg: "var(--nuez)", word: "89" },
      tags: ["Streaming", "Series", "Launch"],
      credits: [["Productora", "Selva Studio"], ["Cliente", "Lionsgate · Pantaya"]],
      paragraphs: { es: ["Pieza de lanzamiento para la primera temporada de Señorita 89, serie original Pantaya · Lionsgate."], en: ["Launch piece for the first season of Señorita 89, a Pantaya · Lionsgate original."] },
    },
    {
      id: "nota-del-asesino",
      client: "Pantaya · Prime",
      title: { es: "Nota del Asesino, Toda la Sangre", en: "Killer's Note, All the Blood" },
      kicker: { es: "Teaser narrativo de la serie Toda la Sangre.", en: "Narrative teaser for the Toda la Sangre series." },
      category: "Streaming Original",
      director: "SELVA",
      year: 2024,
      vimeo: {"id":"1053541383","posterIframe":true},
      agency: "Pantaya · Prime",
      frame: { bg: "var(--negro)", fg: "var(--rosa)", word: "SANGRE" },
      tags: ["Streaming", "Series", "Brand Film"],
      credits: [["Productora", "Selva Studio"], ["Cliente", "Pantaya · Prime"]],
      paragraphs: { es: ["Teaser narrativo para Toda la Sangre, la dimensión sonora y la luz hacen el personaje."], en: ["Narrative teaser for Toda la Sangre, sound and light carry the character."] },
    },
    {
      id: "somos-oro",
      client: "Amazon Prime",
      title: { es: "Somos Oro", en: "Somos Oro" },
      kicker: { es: "Pieza original de Amazon Prime.", en: "Amazon Prime original." },
      category: "Streaming Original",
      director: "SELVA",
      year: 2025,
      vimeo: {"id":"1098353376"},
      agency: "Amazon Studios LATAM",
      frame: { bg: "var(--olivo)", fg: "var(--nuez)", word: "ORO" },
      tags: ["Streaming", "Brand Film"],
      credits: [["Productora", "Selva Studio"], ["Plataforma", "Amazon Prime Video"]],
      paragraphs: { es: ["Pieza original de Amazon Prime, narrativa cinematográfica con identidad cultural mexicana."], en: ["Amazon Prime original, cinematic narrative with Mexican cultural identity."] },
    },
    {
      id: "volver-a-caer",
      client: "ViX",
      title: { es: "Volver a Caer", en: "Volver a Caer" },
      kicker: { es: "Pieza de lanzamiento para ViX.", en: "Launch piece for ViX." },
      category: "Streaming Original",
      director: "SELVA",
      year: 2024,
      vimeo: {"id":"1046913698"},
      agency: "ViX",
      frame: { bg: "var(--rosa)", fg: "var(--vino)", word: "CAER" },
      tags: ["Streaming", "Brand Film"],
      credits: [["Productora", "Selva Studio"], ["Plataforma", "ViX"]],
      paragraphs: { es: ["Pieza de lanzamiento para ViX, drama emocional con dirección de actores cuidada."], en: ["Launch piece for ViX, emotional drama with careful talent direction."] },
    },
    {
      id: "latin-grammy-flamenco",
      client: "Latin Grammy",
      title: { es: "Flamenco Sessions", en: "Flamenco Sessions" },
      kicker: { es: "Serie editorial Flamenco Sessions para Latin Grammy.", en: "Editorial Flamenco Sessions series for Latin Grammy." },
      category: "Music · Documentary",
      director: "SELVA",
      year: 2026,
      vimeo: {"id":"1123041971","posterIframe":true},
      agency: "Latin Grammy",
      frame: { bg: "var(--vino)", fg: "var(--rosa)", word: "FLAMENCO" },
      tags: ["Music", "Documentary", "LATAM"],
      credits: [["Productora", "Selva Studio"], ["Cliente", "Latin Grammy"]],
      paragraphs: { es: ["Sesiones editoriales en formato documental, música, retrato y atmósfera para Latin Grammy."], en: ["Editorial sessions in documentary format, music, portrait and atmosphere for the Latin Grammy."] },
    },
    {
      id: "tia-elena",
      client: "Amazon México",
      title: { es: "Tía Elena", en: "Tía Elena" },
      kicker: { es: "Pieza para Amazon México.", en: "Amazon México piece." },
      category: "Commercial",
      director: "SELVA",
      year: 2025,
      vimeo: {"id":"1098353409"},
      agency: "Amazon México",
      frame: { bg: "var(--nuez)", fg: "var(--vino)", word: "TÍA ELENA" },
      tags: ["Commercial", "Retail"],
      credits: [["Productora", "Selva Studio"], ["Cliente", "Amazon México"]],
      paragraphs: { es: ["Pieza para Amazon México, convivencia familiar con presencia natural de marca."], en: ["Piece for Amazon México, family togetherness with natural brand presence."] },
    },
    {
      id: "toyota-camry",
      client: "Toyota",
      title: { es: "Camry, No es un Sueño", en: "Camry, Not a Dream" },
      kicker: { es: "Launch film para Toyota Camry.", en: "Launch film for Toyota Camry." },
      category: "Commercial",
      director: "SELVA",
      year: 2024,
      vimeo: {"id":"1046925392"},
      agency: "Toyota",
      frame: { bg: "var(--gris)", fg: "var(--nuez)", word: "CAMRY" },
      tags: ["Automotriz", "Launch", "Commercial"],
      credits: [["Productora", "Selva Studio"], ["Cliente", "Toyota"]],
      paragraphs: { es: ["Launch film para Toyota Camry, escala cinematográfica, dirección de talento sobria."], en: ["Launch film for Toyota Camry, cinematic scale, sober talent direction."] },
    },
    {
      id: "alexa-box",
      client: "Amazon México",
      title: { es: "Alexa Box", en: "Alexa Box" },
      kicker: { es: "Pieza de producto para Alexa.", en: "Product piece for Alexa." },
      category: "Commercial",
      director: "SELVA",
      year: 2024,
      vimeo: {"id":"1046927967"},
      agency: "Amazon México",
      frame: { bg: "var(--negro)", fg: "var(--rosa)", word: "ALEXA" },
      tags: ["Commercial", "Product", "Tech"],
      credits: [["Productora", "Selva Studio"], ["Cliente", "Amazon México"]],
      paragraphs: { es: ["Pieza de producto para Alexa, dirección de arte clean, ritmo digital nativo."], en: ["Product piece for Alexa, clean art direction, digital-native pacing."] },
    },
    {
      id: "indio",
      client: "Indio",
      title: { es: "México Unido", en: "México Unido" },
      kicker: { es: "México Unido, pieza para Cervecería Indio.", en: "México Unido, piece for Cervecería Indio." },
      category: "Commercial",
      director: "SELVA",
      year: 2024,
      vimeo: {"id":"1046924774"},
      agency: "Indio",
      frame: { bg: "var(--olivo)", fg: "var(--nuez)", word: "MÉXICO UNIDO" },
      tags: ["Commercial", "CPG", "MX"],
      credits: [["Productora", "Selva Studio"], ["Cliente", "Indio"]],
      paragraphs: { es: ["México Unido para Cervecería Indio, identidad cultural mexicana con tratamiento cinematográfico."], en: ["México Unido for Cervecería Indio, Mexican cultural identity with cinematic treatment."] },
    },
    {
      id: "oleico-circulo",
      client: "Oléico",
      title: { es: "El Círculo que te hace bien", en: "The Circle that Does You Good" },
      kicker: { es: "El Círculo que te hace bien, pieza de marca para Oléico.", en: "The Circle that Does You Good, brand piece for Oléico." },
      category: "Commercial",
      director: "SELVA",
      year: 2026,
      vimeo: {"id":"1192386076"},
      agency: "Oléico",
      frame: { bg: "var(--rosa)", fg: "var(--vino)", word: "EL CÍRCULO" },
      tags: ["Commercial", "CPG", "MX"],
      credits: [["Productora", "Selva Studio"], ["Cliente", "Oléico"]],
      paragraphs: { es: ["El Círculo que te hace bien, pieza de marca para Oléico con tratamiento cinematográfico y dirección de arte cálida."], en: ["The Circle that Does You Good, brand piece for Oléico with cinematic treatment and warm art direction."] },
    },
  ];
  ...
  const directors = [
    {
      ...
      years: "20+ años",
      tagline: {
        es: "Publicidad de alto perfil con una fuerte sensibilidad hacia la comedia.",
        en: "High-profile advertising with a strong sense of comedy."
      },
      bio: {
        es: [
          "Raga dirige hace más de dos décadas. Travellings elegantes, actuaciones auténticas, humor cuando la historia lo permite."
        ],
        en: [
          "Raga has directed for over two decades. Elegant travelling shots, truthful performances, humor when the story allows."
        ]
      },
      clients: ["Toyota", "Amazon Prime", "Apple TV+", "Totalplay", "HBO", "Televisa", "Latin Grammy", "Gaia"],
    ...
    },
    {
      ...
      role: { es: "Dirección publicitaria y contenido digital", en: "Direction · Commercial + digital content" },
      years: "10+ años",
      tagline: {
        es: "Storytelling contemporáneo. Formato vertical nativo.",
        en: "Contemporary storytelling. Native vertical format."
      },
      bio: {
        es: [
          "Brotherhood es la dupla de dirección de Erik Limón y Dani Cabrera. Storytelling contemporáneo pensado para formatos nativos digitales, Reels, TikToks, Shorts. Cuadros precisos, cortes que enganchan."
        ],
        en: [
          "Brotherhood is the directing duo of Erik Limón and Dani Cabrera. Contemporary storytelling designed for digital-native formats, Reels, TikToks, Shorts. Precise frames, cuts that hook."
        ]
      },
      clients: ["Sidral Mundet", "Apple TV+", "Totalplay", "Aeroméxico", "Sonríe de Nuevo AC", "Leo Burnett"],
    ...
    },
    {
      ...
      name: "FER TOVAR",
      handle: "@fertovarf",
      role: { es: "Directora de cine publicitario", en: "Director · Commercial cinema" },
      years: "15+ años",
      tagline: {
      ...
      bio: {
        es: [
          "Fer Tovar dirige con equilibrio entre publicidad y cine de autor. Planos milimétricos, movimiento audaz, edición precisa. Su trabajo en festivales convive con campañas para marcas globales."
        ],
        en: [
          "Fer Tovar directs with a balance between advertising and auteur cinema. Precise framing, bold movement, surgical editing. Her festival work coexists with campaigns for global brands."
        ]
      },
      clients: ["Corvette", "Amazon México", "Hulu", "Amazon Prime", "Volvo", "Cannes Critics' Week"],
      frame: { bg: "var(--olivo)", fg: "var(--nuez)", word: "F" },
      projectIds: ["corvette-cdm", "amazon-hotsale", "amazon-nadie", "grupo-vazol-vivir"],
  ...
  const copy = {
    ...
    heroMeta: {
      es: "Estudio audiovisual · CDMX ✦ Cine publicitario",
      en: "Audiovisual studio · CDMX ✦ Cinema for brands"
    },
    manifestos: {
      v1: { es: ["Cine para marcas.", ""], en: ["Cinema for brands.", ""] },
      v2: { es: ["Contenido que conecta", "por cómo lo dice."], en: ["Content that connects", "by how it says it."] },
      v3: { es: ["Producción", "sustentable."], en: ["Sustainable", "production."] },
    },
    manifestoEditorial: {
      es: "Somos un estudio audiovisual de cine publicitario con base en la Ciudad de México. Creemos que una marca se recuerda por cómo hace sentir, no por cuántas veces se repite. Hacemos cine para marcas, no publicidad que se disfraza de cine. Cuadros milimétricos, actuaciones auténticas, travellings que permanecen. El resultado son piezas que elevan KPIs y se quedan en la memoria.",
      en: "We are an audiovisual studio of commercial cinema based in Mexico City. We believe a brand is remembered for how it makes you feel, not for how many times it repeats itself. We make cinema for brands, not advertising that dresses up as cinema. Precise frames, authentic performances, travelling shots that stay. The result: pieces that raise KPIs and stay in memory."
    },
    valores: [
      {
        n: "01",
        ...
        body: {
          es: "Trabajamos con el rigor del cine: planos pensados, iluminación construida, dirección de actores cuidada. Lo hacemos con herramientas contemporáneas, pero el oficio sigue siendo el mismo.",
          en: "We work with the rigor of cinema: planned frames, constructed lighting, careful direction of talent. We do it with contemporary tools, but the craft remains the same."
        }
      },
      {
        n: "02",
        ...
        body: {
          es: "IA aplicada a producción audiovisual desde Selva Lab. Machine learning para pre-visualización. Producción virtual cuando la locación cuesta más que la idea. La tecnología que no se nota, la que libera tiempo para pensar dos veces.",
          en: "AI applied to audiovisual production from Selva Lab. Machine learning for pre-visualization. Virtual production when the location costs more than the idea. Technology you don't notice, the kind that frees up time to think twice."
        }
      },
      {
        n: "03",
      ...
      {
        n: "04",
        title: { es: "Producción sustentable", en: "Sustainable production" },
        body: {
          es: "Estamos en proceso de certificación B Corp. Producimos midiendo huella de carbono, reduciendo residuos en set, y eligiendo proveedores locales. La sostenibilidad no es declaración, es método.",
          en: "We are in process of B Corp certification. We produce by measuring carbon footprint, reducing on-set waste, and choosing local suppliers. Sustainability isn't a statement, it's a method."
        }
      },
    ],
  };

      ...
      <div style={hdr.inner}>
        ...
        <div style={hdr.right}>
          ...
          <a
            ...
            style={hdr.cta}
            className="desktop-only hdr-cta"
          >
    ...
    <footer className="linen" style={ft.root}>
      ...
      <div style={ft.bottom}>
        <div style={{display:"flex", alignItems:"center", gap:18}}>
          ...
          <div>
            <div style={ft.bottomWord}>SELVA</div>
            <div style={ft.bottomSub}>© 2026</div>
          </div>
        </div>
    ...
    >
      ...
      {needsIframePoster && (
        <div style={{position:"absolute", inset:0, overflow:"hidden", background:"#000"}}>
          <iframe
            src={`https://player.vimeo.com/video/${v.id}${v.h ? "/" + v.h : ""}?background=1&autoplay=1&loop=1&byline=0&title=0&portrait=0&controls=0&muted=1&dnt=1&quality=360p`}
